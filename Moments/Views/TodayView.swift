...
struct TodayView: View {
                        ...
                        if viewModel.isDailyGoalEnabled {
                            HStack(spacing: 8) {
                                if viewModel.isDailyGoalCompleted {
                                    ...
                                    Text("Daily Goal: ✅ Completed".localized)
                                        .font(.subheadline)
                                        .fontWeight(.medium)
                                        .foregroundColor(.green)
                                } else {
                                    ...
                                    Text("Daily Goal: Add 1 moment".localized)
                                        .font(.subheadline)
                                        .fontWeight(.medium)
                                        .foregroundColor(.orange)
                                }
                    ...
                    if viewModel.showGoalCelebration {
                        ZStack {
                            ...
                            VStack(spacing: 20) {
                                ...
                                VStack(spacing: 8) {
                                    Text("Daily Goal Achieved!".localized)
                                        .font(.title)
                                        .fontWeight(.bold)
                                        .foregroundColor(.white)
                                    
                                    Text("Great job! Keep it up! 💪".localized)
                                        .font(.body)
    ...
    private var emptyStateView: some View {
        VStack(spacing: 20) {
            ...
            Text("No moments today yet".localized)
                .font(.title2)
                .foregroundColor(.secondary)
            
            Text("Tap the + button to add your first moment of the day!".localized)
                .font(.body)
                .foregroundColor(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal)
